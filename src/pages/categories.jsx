    ...
    <div className="flex px-4 md:px-16 py-10 gap-8 bg-slate-900">
      ...
      <aside className="w-1/4 space-y-3 bg-gradient-to-br from-black to-green-900/50 rounded-lg">
        ...
        <button
          ...
          className={`text-left block w-full px-4 py-2 rounded-lg font-bangers ${
            selectedCategory === null ? 'bg-green-800 text-white' : 'hover:bg-green-700 text-gray-300'
          }`}
        >
          Tất cả
        </button>
        {loadingCategories ? (
          ...
          categories.map((cat) => (
            <button
              ...
              className={`block w-full px-4 py-2 rounded-lg text-left font-bangers ${
                selectedCategory === cat.id ? 'bg-green-800 text-white' : 'hover:bg-green-700 text-gray-300'
              }`}
            >
              {cat.name}
            </button>
                ...
                p === '...' ? (
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg ${
                      page === p ? 'bg-green-700 text-white' : 'bg-gray-700 text-gray-300 hover:bg-green-600'
                    }`}
                  >
                    {p}
                  </button>
